...
--
-- Q1 from docs/design-decisions/wires-and-bundles.md:
...
--
-- See:
--   docs/design-decisions/wires-and-bundles.md — Q1 resolution + alternatives
--   docs/design-decisions/build-plan.md — Phase 2
...
comment on column entity_action_bindings.target is
  'Q1 wire target. JSON value: string "self" (action runs on source — default), OR object {rel, dir?, kind?} (action runs on entities discovered via entity_pairings). See docs/design-decisions/wires-and-bundles.md.';
